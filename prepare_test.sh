...
./start.sh -c ./prepare/insert -h ${cn_svc_ip} -P 6001 -t 100 -d 2 -b t >time.log &
...
./start.sh -c ./prepare/update -h ${cn_svc_ip} -P 6001 -t 100 -d 2 -b t >time.log &
...
./start.sh -c ./prepare/delete -h ${cn_svc_ip} -P 6001 -t 100 -d 2 -b t >time.log &
